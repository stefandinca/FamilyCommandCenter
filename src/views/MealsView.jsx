  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-4 md:p-8 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-4 md:mb-6">
          <div className="flex-1 min-w-0">
            <h1 className="text-2xl md:text-4xl font-bold bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent flex items-center gap-2 md:gap-3">
              <span className="text-2xl md:text-4xl">🍽️</span>
              <span>Meal Menu</span>
            </h1>
            <p className="text-gray-500 mt-1 md:mt-2 text-sm md:text-lg">Plan and organize family meals</p>
          </div>
          <button
            onClick={() => setIsAddingMeal(true)}
            className="bg-gradient-to-r from-orange-500 to-amber-500 text-white px-4 md:px-6 py-2 md:py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 flex items-center gap-2 w-full sm:w-auto justify-center text-sm md:text-base"
          >
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6">
        ...
        <div>
          {filterCategory !== 'all' && (
            <h2 className="text-base md:text-lg font-semibold text-gray-700 mb-3 md:mb-4 capitalize">
              {filterCategory}
            </h2>
          )}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
